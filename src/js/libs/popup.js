	...
	eventsPopup() {
		...
		document.addEventListener("click", function (e) {
			...
			if (buttonCancel || buttonConfirm) {
				e.stopPropagation();  // Останавливаем распространение события, чтобы оно не попало на родительский попап
				e.preventDefault();    // Прерываем стандартное действие
				return;                // Не закрываем основной попап
			}
